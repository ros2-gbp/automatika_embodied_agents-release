...
%global pkg_name automatika_embodied_agents
%global normalized_pkg_name %{lua:return (string.gsub(rpm.expand('%{pkg_name}'), '_', '-'))}

Name:           ros-lyrical-automatika-embodied-agents
Version:        0.7.4
Release:        1%{?dist}
...
* Wed Apr 29 2026 Automatika Robotics <contact@automatikarobotics.com> - 0.7.0-3
- Autogenerated by Bloom

* Tue Apr 28 2026 Automatika Robotics <contact@automatikarobotics.com> - 0.7.0-2
- Autogenerated by Bloom

* Tue Apr 21 2026 Automatika Robotics <contact@automatikarobotics.com> - 0.7.0-1
- Autogenerated by Bloom
